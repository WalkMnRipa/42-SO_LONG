...
/*   Updated: 2024/07/13 19:51:42 by jcohen           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	move_player(t_game *game, int dx, int dy)
{
	...
	if (game->map.map[new_y][new_x] == EXIT && game->map.collectibles == 0)
	{
		game->victory = true;
		return (1);
	}
...
int	key_press(int keycode, t_game *game)
{
	...
	if (game->victory)
	{
		mlx_string_put(game->mlx, game->win, WINDOW_WIDTH / 2 - 50,
			WINDOW_HEIGHT / 2, 0xFFFFFF, "You Win!");
